...
from sqlalchemy import select, func, exists, desc, and_
from sqlalchemy.orm import selectinload, aliased

from app.core.database import get_db
from app.models.models import Meme, User, Like, Comment, Tag, Subject, meme_tags, Notification, NotificationType, follows
...
async def get_popular_content(db: AsyncSession = Depends(get_db)):
    ...
    # Топ 5 персонажей по количеству мемов
    subjects_stmt = (
